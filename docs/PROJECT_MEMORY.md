# Mémoire de projet — Pixel Creator

Mémoire persistante du projet. Concise, structurée, et toujours explicite sur la nature
de ce qu'elle affirme.

> **Ce document est la mémoire interne, pas la porte d'entrée.** La documentation publique
> — guide utilisateur et documentation développeur, en anglais — part de
> [`README.md`](README.md), qui renvoie aussi ici. Ce fichier s'appelait `docs/README.md`
> jusqu'à ce que `docs/` expose ces deux chemins d'entrée ; **la table des ADR ci-dessous
> reste la liste complète et fait autorité.**
